...
function calc_view2D_width() {
    ...
    c_size_x = (0, F_Math_1._max)([0.1, (0, F_Math_1._round)(1.00 * (0, F_Math_1._min)([col_px, row_px]), 2)]);
    c_size_y = (0, F_Math_1._max)([0.1, (0, F_Math_1._round)(1.00 * (0, F_Math_1._min)([col_px, row_px]), 2)]);
...
function calc_view2D_top() {
    ...
    if (top_x > map_wdth - view_wdth)
        top_x = map_wdth - view_wdth;
    if (top_x < 0)
        top_x = 0;
    let top_y = view_hght / 2 - pd.y * c_size_y;
    if (top_y > map_hght - view_hght)
        top_y = map_hght - view_hght;
    if (top_y < 0)
        top_y = 0;
